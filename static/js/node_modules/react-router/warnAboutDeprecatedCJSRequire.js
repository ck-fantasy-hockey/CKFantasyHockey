...
module.exports = function (member) {
  printWarning('Please use `require("react-router").%s` instead of `require("react-router/%s")`. ' + "Support for the latter will be removed in the next major release.", [member, member]);
};